...
- Fixed Kimi models routed through the exact `merlin-9router/kimi/*` namespace missing Moonshot's provider-specific thinking, preserved-reasoning, forced-tool, timeout, and model-family compatibility policies, without changing other Merlin routes or providers.
